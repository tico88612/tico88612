...
<details>
  ...
  - [kubernetes/kubectl](https://github.com/kubernetes/kubectl) - Issue tracker and mirror of kubectl code (4 days ago)
  ...
  - [kubernetes-sigs/inference-perf](https://github.com/kubernetes-sigs/inference-perf) ([v0.6.1](https://github.com/kubernetes-sigs/inference-perf/releases/tag/v0.6.1), 3 days ago) - GenAI inference performance benchmarking tool
  - [kubernetes/kubernetes](https://github.com/kubernetes/kubernetes) ([v1.36.3](https://github.com/kubernetes/kubernetes/releases/tag/v1.36.3), 3 days ago) - Production-Grade Container Scheduling and Management
  ...
  - [Fix: Slack inviter link](https://github.com/kubernetes/k8s.io/pull/9740) on [kubernetes/k8s.io](https://github.com/kubernetes/k8s.io) (5 days ago)
