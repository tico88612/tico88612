...
<details>
  ...
  - [bpg/terraform-provider-proxmox](https://github.com/bpg/terraform-provider-proxmox) ([v0.95.1-rc1](https://github.com/bpg/terraform-provider-proxmox/releases/tag/v0.95.1-rc1), 6 days ago) - Terraform / OpenTofu Provider for Proxmox VE
  ...
  - [Graduate old alpha metrics storage encryption metric to Beta](https://github.com/kubernetes/kubernetes/pull/137031) on [kubernetes/kubernetes](https://github.com/kubernetes/kubernetes) (3 days ago)
