...
<details>
  ...
  - [coredns/deployment](https://github.com/coredns/deployment) - Scripts, utilities, and examples for deploying CoreDNS. (3 weeks ago)
  ...
  - [meshery/meshery](https://github.com/meshery/meshery) ([v0.7.149](https://github.com/meshery/meshery/releases/tag/v0.7.149), 1 day ago) - Meshery, the cloud native manager
  - [backstage/backstage](https://github.com/backstage/backstage) ([v1.33.0-next.3](https://github.com/backstage/backstage/releases/tag/v1.33.0-next.3), 2 days ago) - Backstage is an open framework for building developer portals
  ...
  - [jaegertracing/jaeger](https://github.com/jaegertracing/jaeger) ([v1.63.0](https://github.com/jaegertracing/jaeger/releases/tag/v1.63.0), 4 days ago) - CNCF Jaeger, a Distributed Tracing Platform
  - [jaegertracing/jaeger-ui](https://github.com/jaegertracing/jaeger-ui) ([v1.63.0](https://github.com/jaegertracing/jaeger-ui/releases/tag/v1.63.0), 4 days ago) - Web UI for Jaeger
  ...
  - [inspektor-gadget/inspektor-gadget](https://github.com/inspektor-gadget/inspektor-gadget) - Inspektor Gadget is a set of tools and framework for data collection and system inspection on Kubernetes clusters and Linux hosts using eBPF (2 days ago)
